...
export const metadata: Metadata = {
  ...
  description: 'Get deep insights on GitHub repositories. Analyze summaries, stars, pull requests, version updates, and cool facts about any open source project.',
  generator: 'v0.app',
  viewport: {
    width: 'device-width',
    initialScale: 1,
